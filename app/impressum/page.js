...
export default function Imprint(){
  return <LegalDocument pageId="impressum" title="Impressum" intro="Anbieterkennzeichnung für AS Workspace Gold gemäß § 5 Digitale-Dienste-Gesetz (DDG).">
    ...
    <LegalSection title="Kontakt"><p>E-Mail: <a href="mailto:sebastian.auls@gmail.com">sebastian.auls@gmail.com</a></p><p>Für datenschutzbezogene Anliegen kann dieselbe E-Mail-Adresse mit dem Betreff „Datenschutz – AS Workspace Gold“ verwendet werden.</p></LegalSection>
    ...
    <LegalSection title="Hinweis zum aktuellen Angebot"><p>AS Workspace Gold befindet sich in einem kostenlosen, kontrollierten Testbetrieb. Die auf der Produktseite dargestellten Preise sind eine transparente Produktvorschau; die Bezahlfunktion ist deaktiviert und durch Registrierung wird kein kostenpflichtiges Abonnement abgeschlossen.</p></LegalSection>
  </LegalDocument>
}
