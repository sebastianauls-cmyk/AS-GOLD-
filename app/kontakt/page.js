...
export default function Contact(){
  return <LegalDocument pageId="kontakt" title="Kontakt" intro="Direkter Kontakt ohne zusätzliches Webformular und ohne weitere Tracking-Dienste.">
    ...
    <LegalNotice><b>Passender Betreff</b><p>Allgemein: „AS Workspace Gold“ · Promo-Code: „Promo-Code – AS Workspace Gold“ · Datenschutz: „Datenschutz – AS Workspace Gold“ · Widerruf: Nutzen Sie bevorzugt die öffentliche Funktion <a href="/widerruf">Vertrag widerrufen</a>.</p></LegalNotice>
