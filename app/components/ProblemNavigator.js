...
export function ProblemNavigator(){
  ...
  return createPortal(<section id="asgold-problem-navigator-react" style={{margin:'26px 0 10px',padding:18,border:'1px solid #dccb9f',borderRadius:18,background:'#fff',boxShadow:'0 12px 34px rgba(72,55,18,.08)'}}>
    ...
    <div style={{display:'flex',gap:8,flexWrap:'wrap',marginTop:9}}><button type="button" onClick={voice} style={{padding:'10px 13px',border:'1px solid #d5c38f',borderRadius:11,background:'#fffaf0',color:'#5b4618',fontWeight:800}}>{listening?'⏹':'🎙'} {listening?c.stop:c.voice}</button><button type="button" onClick={analyse} style={{padding:'10px 14px',border:0,borderRadius:11,background:'#8f6e25',color:'#fff',fontWeight:800}}>{c.analyse}</button></div>
