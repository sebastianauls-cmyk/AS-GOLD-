...
const audienceCopy={
  ...
  vi:{title:'AS Gold đặc biệt hữu ích cho ai',lead:'Bạn không cần biết trước một “loại hồ sơ” cụ thể. Trước tiên hãy chọn cách bạn muốn dùng AS Gold.',items:[['Cá nhân','Sắp xếp và xử lý dễ hiểu các thư từ, hợp đồng, văn bản cơ quan, tranh chấp, du lịch, xe cộ và hồ sơ có nhiều tài liệu.'],['Người tự kinh doanh và doanh nghiệp nhỏ','Xử lý có cấu trúc hồ sơ khách hàng, yêu cầu thanh toán, hợp đồng, hóa đơn, bảo hiểm, nhân sự và thủ tục hành chính.'],['Văn phòng, hành chính và trợ lý','Tập trung email, thời hạn, tài liệu, phản hồi và việc tiếp nối trong một quy trình có thể truy vết.'],['Nhóm quản lý hồ sơ khách hàng','Cùng quản lý nhiều khách hàng, hồ sơ, tài liệu, phê duyệt, trạng thái và thư đã chuẩn bị.']]}
}
