...
import { howAsGoldWorksCopy } from '../lib/asGoldIntroCopy.mjs'
...
const copy={
  ...
  vi:{title:'AS Gold có thể làm gì?',lead:'AS Gold giúp hồ sơ phức tạp trở nên rõ ràng và dễ quản lý.',items:['Tập hợp tài liệu, email và thông tin','Nhận diện thời hạn, thiếu sót, mâu thuẫn và rủi ro','Tạo đánh giá đèn trạng thái, bước tiếp theo và thư phản hồi','Xuất kết quả và kết nối email, đám mây hoặc nơi lưu trữ riêng']}
}
