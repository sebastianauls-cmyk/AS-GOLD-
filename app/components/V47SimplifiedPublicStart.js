...
const copy={
  de:{start:'Fall starten',login:'Bereits registriert? Anmelden',headline:'Was ist passiert?',sub:'Wählen Sie Ihr Thema. AS Gold führt Sie danach Schritt für Schritt weiter.',more:'Weitere Themen',why:'Mehr als eine normale KI',whyLead:'AS Gold beantwortet nicht nur eine einzelne Frage, sondern baut aus Ihren Unterlagen einen nachvollziehbaren Fall.',benefits:['Dokumente zusammenführen und zuordnen','Fristen, Risiken und offene Punkte sichtbar machen','Einen priorisierten nächsten Schritt anzeigen','Fallakte, Schreiben und Übergabe für Berater vorbereiten'],cats:[['Arbeit & Kündigung','Kündigung, Arbeitszeugnis, Lohn, Aufhebungsvertrag'],['Behörden & Leistungen','Bescheid, Bürgergeld, Wohngeld, Widerspruch'],['Verkehr & Bußgeld','Bußgeld, Fahrverbot, Unfall, MPU'],['Verträge & Forderungen','Vertrag, Rechnung, Mahnung, Inkasso'],['Versicherung & Schäden','Schaden, Ablehnung, Regulierung'],['Wohnen & Miete','Mietvertrag, Kündigung, Nebenkosten'],['Familie & Erbe','Trennung, Unterhalt, Nachlass, Erbe'],['Sonstiger Vorgang','Wenn Ihr Thema nicht eindeutig passt']]},
  en:{start:'Start case',login:'Already registered? Sign in',headline:'What happened?',sub:'Choose your topic. AS Gold then guides you step by step.',more:'More topics',why:'More than a normal AI',whyLead:'AS Gold does not just answer one question. It turns your documents into a traceable case.',benefits:['Connect and assign documents','Surface deadlines, risks and missing information','Show one prioritized next step','Prepare a case file, letters and professional handoff'],cats:[['Work & termination','Termination, reference, pay, settlement'],['Authorities & benefits','Decision, benefits, objection'],['Traffic & fines','Fine, driving ban, accident'],['Contracts & claims','Contract, invoice, reminder, debt collection'],['Insurance & damage','Damage, denial, settlement'],['Housing & rent','Lease, termination, service charges'],['Family & inheritance','Separation, support, estate'],['Other matter','If your topic does not fit clearly']]},
  fr:{start:'Commencer le dossier',login:'Déjà inscrit ? Se connecter',headline:'Que s’est-il passé ?',sub:'Choisissez votre sujet. AS Gold vous guide ensuite étape par étape.',more:'Autres sujets',why:'Plus qu’une IA ordinaire',whyLead:'AS Gold ne répond pas seulement à une question : il transforme vos documents en dossier traçable.',benefits:['Relier et classer les documents','Afficher délais, risques et informations manquantes','Montrer une prochaine étape prioritaire','Préparer dossier, courriers et transmission professionnelle'],cats:[['Travail & licenciement','Licenciement, salaire, certificat'],['Administrations & prestations','Décision, prestation, recours'],['Circulation & amendes','Amende, interdiction, accident'],['Contrats & créances','Contrat, facture, relance'],['Assurance & dommages','Sinistre, refus, règlement'],['Logement & loyer','Bail, résiliation, charges'],['Famille & succession','Séparation, pension, héritage'],['Autre situation','Si votre sujet ne correspond pas clairement']]},
}
