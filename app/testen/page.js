...
export const metadata={title:'AS Gold sicher testen',description:'Kontrollierter AS-Gold-V48-Test mit ausschliesslich synthetischen Daten und einer vorbereiteten Musterdatei.'}

const sample='/testdaten/AS_Gold_Synthetischer_Testfall_V29.pdf'

export default function TestingGuide(){
  return <LegalDocument pageId="testen" eyebrow="AS Gold · Testerbetrieb V48" title="AS Gold V48 sicher ausprobieren" intro="Mit diesem Ablauf können Tester den aktuellen V48-Stand vollständig erkunden, ohne echte Kundendaten oder sensible Informationen zu verwenden.">
    ...
    <LegalSection title="Ihr sicherer V48-Test in vier Schritten">
    ...
    <LegalSection title="Unser Qualitätsmaßstab">
      <p>AS Gold soll nicht nur Fragen beantworten. Der Test soll zeigen, ob aus Dokumenten ein verständlicher, nachvollziehbarer Fall entsteht: mit Quellen, Lücken, Fristen, Ampel, Timeline, nächsten Aufgaben und einer sauberen Übergabe. Jede Sackgasse, doppelte Bedienfunktion, unklare Auswahl oder nicht nachvollziehbare Empfehlung gilt als Abnahmefehler.</p>
    </LegalSection>
    ...
    <LegalSection title="Rückmeldung geben">
      ...
      <div className="testerActions"><a className="primary btn" href="/?start=register">Kostenlos testen</a><a className="secondary btn" href="mailto:sebastian.auls@gmail.com?subject=AS%20Gold%20V48%20Testfeedback">V48-Testfeedback per E-Mail</a></div>
    </LegalSection>

    <LegalSection title="Klare Freigabegrenze"><p>V48 ist ein kontrollierter Produkttest. Echte personenbezogene Kundendaten, besonders sensible Daten, Zahlungsvorgänge und eine Nutzung als Ersatz für individuelle Rechts- oder Steuerberatung sind nicht freigegeben.</p></LegalSection>
  </LegalDocument>
}
