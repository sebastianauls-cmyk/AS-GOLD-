...
export default function Cookies(){
  return <LegalDocument pageId="cookies" title="Cookies & Browser-Speicher" intro="AS Gold setzt derzeit keine Werbe-, Reichweitenmessungs- oder Profiling-Cookies ein.">
