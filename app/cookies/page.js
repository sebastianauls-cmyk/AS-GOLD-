...
export const metadata={title:'Cookies & Browser-Speicher',description:'Informationen zu Cookies, Sitzungen und lokalem Speicher bei ASH Workspace Gold.'}

export default function Cookies(){
  return <LegalDocument pageId="cookies" title="Cookies & Browser-Speicher" intro="ASH Workspace Gold setzt derzeit keine Werbe-, Reichweitenmessungs- oder Profiling-Cookies ein.">
