export const changeAreas=[
  'Gesamtes ASH Workspace · alle Bereiche',
  ...
  'Sonstige Änderung an ASH Workspace'
]

const copy={
  de:{
    badge:'GESCHÜTZTE ÄNDERUNGSZENTRALE',title:'Vollzugriff auf das gesamte ASH Workspace',
    ...
    passwordRule:'Zwei Passwörter, klar getrennte Aufgaben',accessPassword:'Passwort 1 · Vollzugriff auf alles',accessHelp:'Damit kann jede autorisierte Person das gesamte ASH Workspace öffnen, in allen Bereichen arbeiten und Änderungen an jedem Inhalt, jeder Funktion und jedem Modul vorbereiten.',masterPassword:'Passwort 2 · Freigabe der Live-Version',masterHelp:'Nur Sebastian kennt es. Es wird genau einmal eingegeben, nachdem die vollständige Änderung sichtbar geprüft wurde und bevor die geänderte Version live veröffentlicht werden darf.',
    newRequest:'Änderung an ASH Workspace vorbereiten',requester:'Vorbereitet von',area:'Betroffener Bereich',requestTitle:'Kurzer Titel',change:'Was soll in ASH Workspace geändert werden?',reason:'Warum soll es geändert werden?',notes:'Gewünschte Darstellung, Funktion oder technische Umsetzung (optional)',priority:'Priorität',submit:'Änderungsentwurf speichern',required:'Bitte alle Pflichtfelder vollständig ausfüllen.',submitted:'Der Änderungsentwurf wurde gespeichert. Die bisherige Live-Version wurde nicht verändert.',
