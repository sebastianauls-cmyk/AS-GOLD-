...
export function TesterPaused(){
  return <LegalDocument pageId="testen" eyebrow="ASH Workspace Gold · Externer Testzugang pausiert" title="Testerzugang derzeit geschlossen" intro="ASH Workspace Gold befindet sich in der internen Abschlussprüfung. Bis zur ausdrücklichen Freigabe läuft die Qualitätssicherung ausschließlich mit synthetischen Testfällen; externe Tester und echte Kundendaten sind bewusst ausgeschlossen.">
    <LegalNotice tone="warning"><b>Aktuell keine externe Testerfreigabe.</b><p>Bitte keinen Test starten und keine Daten hochladen. Die Bezahlfunktion bleibt deaktiviert.</p></LegalNotice>
    ...
    <LegalSection title="Nächster Schritt">
      <p>Ein externer Testerzugang wird erst wieder geöffnet, wenn ASH Workspace Gold intern abgeschlossen und dafür ausdrücklich freigegeben wurde.</p>
    </LegalSection>
  </LegalDocument>
}
