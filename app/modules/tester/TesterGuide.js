...
export function TesterGuide(){
  return <LegalDocument pageId="testen" eyebrow="Testerbetrieb V74" title="AS Gold V74 sicher ausprobieren" intro="Hier können Sie den vollständigen modularen Ablauf prüfen, den Link weiterleiten und ohne echte Kundendaten oder eine Zahlung testen." updated="3. September 2026" localizedExtra={<TesterShareButton/>} localizedExtraAfterSection={0}>
    ...
    <LegalSection title="Testfeedback"><p><a className="primary btn" href="mailto:sebastian.auls@gmail.com?subject=AS%20Gold%20V74%20Testfeedback">Feedback zu V74 senden</a></p><p>V74 ist ein kontrollierter Produkttest. Ergebnisse müssen vor einer verbindlichen Verwendung weiterhin geprüft und ausdrücklich freigegeben werden.</p></LegalSection>
  </LegalDocument>
}
