...
export function generateCustomerRoadmap(supabase,{caseId,style,outputLanguage,referenceLanguage,onProgress}) {
  return runRoadmapContinuation(options=>supabase.functions.invoke('gold-case-roadmap',options),{action:'generate',case_id:caseId,style,output_language:outputLanguage,reference_language:referenceLanguage,acknowledged:true,privacy_notice_version:PRIVACY_NOTICE_VERSION,terms_version:TERMS_VERSION},{onProgress})
}
