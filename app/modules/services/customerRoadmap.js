...
export function generateCustomerRoadmap(supabase,{caseId,style,outputLanguage,referenceLanguage,onProgress}) {
  return supabase.functions.invoke('gold-case-roadmap',{body:{action:'enqueue',analysis_mode:'complete',case_id:caseId,style,output_language:outputLanguage,reference_language:referenceLanguage,acknowledged:true,privacy_notice_version:PRIVACY_NOTICE_VERSION,terms_version:TERMS_VERSION}})
}
