...
function coreProperties(title){
  ...
  return XML_HEADER+
    ...
    '<dc:title>'+escapeXml(title,255)+'</dc:title><dc:creator>ASH Workspace Gold</dc:creator>'+
    '<cp:lastModifiedBy>ASH Workspace Gold</cp:lastModifiedBy>'+
...
export async function createXlsxBlob(rows){
  ...
  zip.file('docProps/core.xml',coreProperties(cleanXmlText(normalized[0]?.[0]||'ASH Workspace Gold',255)))
  zip.file('docProps/app.xml',XML_HEADER+
    '<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" '+
    'xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">'+
    '<Application>ASH Workspace Gold</Application><DocSecurity>0</DocSecurity><ScaleCrop>false</ScaleCrop>'+
  ...
  zip.file('xl/workbook.xml',XML_HEADER+
    ...
    '<sheets><sheet name="ASH Workspace Gold" sheetId="1" r:id="rId1"/></sheets><calcPr calcId="0"/></workbook>')
...
function presentationTheme(){
  return XML_HEADER+'<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="ASH Workspace Gold">'+
    '<a:themeElements><a:clrScheme name="ASH Workspace Gold">'+
    ...
    '<a:fmtScheme name="ASH Workspace Gold"><a:fillStyleLst>'+
...
function slideLayout(){
  return XML_HEADER+'<p:sldLayout xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="'+OFFICE_REL_NS+'" '+
    'xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" preserve="1"><p:cSld name="ASH Workspace Gold">'+
...
export async function createPptxBlob(rows){
  ...
  zip.file('docProps/app.xml',XML_HEADER+
    '<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" '+
    'xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">'+
    '<Application>ASH Workspace Gold</Application><PresentationFormat>Widescreen</PresentationFormat>'+
