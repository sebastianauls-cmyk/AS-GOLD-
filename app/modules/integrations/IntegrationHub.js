...
function ProviderAction({configured,href,children}){
  if(!configured) return <span role="link" aria-disabled="true" style={disabledButton}>Anbieterfreigabe für AS Gold noch nicht abgeschlossen</span>
