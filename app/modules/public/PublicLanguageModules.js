...
const copy={
  ...
  en:{interfaceTitle:'1. Interface language',interfaceLabel:'Interface',outputTitle:'2. Language for output & customers',outputLabel:'Output language',outputHelp:'Documents, results and letters are created for customers or other people in {language}. The interface remains independent.',presenter:'Who should explain AS Workspace Gold?',female:'Woman explains',male:'Man explains',play:'Play explainer video',back:'Back'},
  fr:{interfaceTitle:'1. Langue de l’interface',interfaceLabel:'Interface',outputTitle:'2. Langue des résultats et des clients',outputLabel:'Langue de sortie',outputHelp:'Les documents, résultats et courriers destinés aux clients ou à d’autres personnes sont créés en {language}. L’interface reste indépendante.',presenter:'Qui doit expliquer AS Workspace Gold ?',female:'Explication par une femme',male:'Explication par un homme',play:'Lire la vidéo explicative',back:'Retour'},
  tr:{interfaceTitle:'1. Arayüz dili',interfaceLabel:'Arayüz',outputTitle:'2. Çıktı ve müşteri dili',outputLabel:'Çıktı dili',outputHelp:'Belgeler, sonuçlar ve yazılar müşteriler veya diğer kişiler için {language} dilinde oluşturulur. Arayüz bundan bağımsız kalır.',presenter:'AS Workspace Gold’u kim anlatsın?',female:'Kadın anlatsın',male:'Erkek anlatsın',play:'Tanıtım videosunu oynat',back:'Geri'},
  pl:{interfaceTitle:'1. Język interfejsu',interfaceLabel:'Interfejs',outputTitle:'2. Język wyników i klientów',outputLabel:'Język wyniku',outputHelp:'Dokumenty, wyniki i pisma dla klientów lub innych osób są tworzone w języku {language}. Język interfejsu pozostaje niezależny.',presenter:'Kto ma wyjaśnić AS Workspace Gold?',female:'Wyjaśnia kobieta',male:'Wyjaśnia mężczyzna',play:'Odtwórz film objaśniający',back:'Wstecz'},
  ru:{interfaceTitle:'1. Язык интерфейса',interfaceLabel:'Интерфейс',outputTitle:'2. Язык результата и клиента',outputLabel:'Язык результата',outputHelp:'Документы, результаты и письма для клиентов или других лиц создаются на языке: {language}. Язык интерфейса выбирается независимо.',presenter:'Кто объяснит AS Workspace Gold?',female:'Объясняет женщина',male:'Объясняет мужчина',play:'Воспроизвести видео',back:'Назад'},
  ar:{interfaceTitle:'1. لغة الواجهة',interfaceLabel:'الواجهة',outputTitle:'2. لغة النتائج والعملاء',outputLabel:'لغة الإخراج',outputHelp:'تُنشأ المستندات والنتائج والخطابات للعملاء أو للأشخاص الآخرين باللغة {language}. وتبقى لغة الواجهة مستقلة.',presenter:'من يشرح AS Workspace Gold؟',female:'تشرح امرأة',male:'يشرح رجل',play:'تشغيل الفيديو التوضيحي',back:'رجوع'},
  fa:{interfaceTitle:'1. زبان رابط',interfaceLabel:'رابط',outputTitle:'2. زبان خروجی و مشتری',outputLabel:'زبان خروجی',outputHelp:'اسناد، نتایج و نامه‌ها برای مشتریان یا افراد دیگر به زبان {language} ایجاد می‌شوند. زبان رابط مستقل می‌ماند.',presenter:'چه کسی AS Workspace Gold را توضیح دهد؟',female:'توضیح با صدای زن',male:'توضیح با صدای مرد',play:'پخش ویدیوی توضیحی',back:'بازگشت'},
  ro:{interfaceTitle:'1. Limba interfeței',interfaceLabel:'Interfață',outputTitle:'2. Limba rezultatelor și a clienților',outputLabel:'Limba rezultatului',outputHelp:'Documentele, rezultatele și scrisorile pentru clienți sau alte persoane sunt create în {language}. Interfața rămâne independentă.',presenter:'Cine să explice AS Workspace Gold?',female:'Explică o femeie',male:'Explică un bărbat',play:'Redă videoclipul explicativ',back:'Înapoi'},
  bg:{interfaceTitle:'1. Език на интерфейса',interfaceLabel:'Интерфейс',outputTitle:'2. Език на резултатите и клиентите',outputLabel:'Език на резултата',outputHelp:'Документите, резултатите и писмата за клиенти или други лица се създават на {language}. Интерфейсът остава независим.',presenter:'Кой да обясни AS Workspace Gold?',female:'Обяснява жена',male:'Обяснява мъж',play:'Пусни обяснителното видео',back:'Назад'},
  vi:{welcome:'Chào mừng đến với AS Workspace Gold – rất vui vì bạn có mặt.',interfaceTitle:'1. Ngôn ngữ giao diện',interfaceLabel:'Giao diện',outputTitle:'2. Ngôn ngữ kết quả và khách hàng',outputLabel:'Ngôn ngữ kết quả',outputHelp:'Tài liệu, kết quả và thư cho khách hàng hoặc người khác được tạo bằng {language}. Ngôn ngữ giao diện vẫn độc lập.',presenter:'Ai sẽ giải thích AS Workspace Gold?',female:'Nữ thuyết trình',male:'Nam thuyết trình',play:'Phát video giải thích',back:'Quay lại'}
}

const warmWelcome={
  de:'Herzlich willkommen bei AS Workspace Gold – hier sind Sie richtig und finden in Ruhe den nächsten Schritt.',
  en:'A warm welcome to AS Workspace Gold – you are in the right place to find your next step at your own pace.',
  fr:'Bienvenue chez AS Workspace Gold – vous êtes au bon endroit pour trouver sereinement la prochaine étape.',
  tr:'AS Workspace Gold’a içtenlikle hoş geldiniz – bir sonraki adımınızı sakince bulmak için doğru yerdesiniz.',
  pl:'Serdecznie witamy w AS Workspace Gold – jesteś we właściwym miejscu, aby spokojnie znaleźć kolejny krok.',
  ru:'Добро пожаловать в AS Workspace Gold — здесь вы спокойно найдёте правильный следующий шаг.',
  ar:'أهلاً وسهلاً بك في AS Workspace Gold — أنت في المكان المناسب لتجد خطوتك التالية بهدوء.',
  fa:'صمیمانه به AS Workspace Gold خوش آمدید — اینجا جای مناسبی است تا با آرامش گام بعدی را پیدا کنید.',
  ro:'Bine ați venit la AS Workspace Gold – sunteți în locul potrivit pentru a găsi în liniște următorul pas.',
  bg:'Добре дошли в AS Workspace Gold – тук сте на правилното място, за да намерите спокойно следващата стъпка.',
...
export function PublicLanguageModules({language,onLanguageChange,outputLanguage,onOutputLanguageChange,onPlayExplainer}){
  ...
  return <section className="publicLanguageModules" lang={language} dir={language==='ar'||language==='fa'?'rtl':'ltr'} aria-label={`${text.interfaceTitle}; ${text.outputTitle}`}>
    ...
    <button type="button" className="publicBackButton" data-persistent-back dir="ltr" onClick={returnToGerman} aria-label="Back to German – Oberfläche und Kundensprache auf Deutsch zurückstellen">← 🇩🇪 Back to German / Zurück zu Deutsch</button>
