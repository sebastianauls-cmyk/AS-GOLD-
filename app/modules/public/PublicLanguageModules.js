...
const warmWelcome={
  ...
  fr:'Bienvenue chez ASH Workspace Gold – vous êtes au bon endroit pour trouver sereinement la prochaine étape.',
  tr:'ASH Workspace Gold’a içtenlikle hoş geldiniz – bir sonraki adımınızı sakince bulmak için doğru yerdesiniz.',
  pl:'Serdecznie witamy w ASH Workspace Gold – jesteś we właściwym miejscu, aby spokojnie znaleźć kolejny krok.',
  ru:'Добро пожаловать в ASH Workspace Gold — здесь вы спокойно найдёте правильный следующий шаг.',
  ar:'أهلاً وسهلاً بك في ASH Workspace Gold — أنت في المكان المناسب لتجد خطوتك التالية بهدوء.',
  fa:'صمیمانه به ASH Workspace Gold خوش آمدید — اینجا جای مناسبی است تا با آرامش گام بعدی را پیدا کنید.',
  ro:'Bine ați venit la ASH Workspace Gold – sunteți în locul potrivit pentru a găsi în liniște următorul pas.',
  bg:'Добре дошли в ASH Workspace Gold – тук сте на правилното място, за да намерите спокойно следващата стъпка.',
  vi:'Chào mừng bạn đến với ASH Workspace Gold – đây là nơi phù hợp để bạn bình tĩnh tìm ra bước tiếp theo.'
}
