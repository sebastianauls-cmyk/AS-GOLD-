...
export function InstallAppButton({language='de',surface='public'}){
  ...
  useEffect(()=>{
    ...
    const syncInstalled=()=>setInstalled(installationAccepted||displayMode?.matches||window.navigator.standalone===true)
