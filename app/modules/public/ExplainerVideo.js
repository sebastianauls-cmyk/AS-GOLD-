...
const copy={
  de:{title:'ASH Workspace Gold kurz erklärt',lead:'Das aktuelle Erklärvideo zum neuesten ASH-Workspace-Gold-Stand.',language:'Videosprache',voice:'Video-Ausgabe',female:'Weiblich',male:'Männlich',loading:'Video wird geladen …',show:'▶ ASH Workspace Gold in 90 Sekunden ansehen',hide:'Video schließen',maleFallback:'Die männliche Fassung dieser Sprache wird noch verarbeitet. Falls sie noch nicht verfügbar ist, wird vorübergehend die aktuelle Sprachfassung gezeigt.'},
  en:{title:'ASH Workspace Gold explained briefly',lead:'The current explainer video for the latest ASH Workspace Gold version.',language:'Video language',voice:'Presenter',female:'Female',male:'Male',loading:'Loading video …',show:'▶ Watch ASH Workspace Gold in 90 seconds',hide:'Close video',maleFallback:'The male version in this language is still being processed. Until it is ready, the current language version may be shown temporarily.'},
  fr:{title:'ASH Workspace Gold expliqué brièvement',lead:'La vidéo explicative actuelle de la dernière version d’ASH Workspace Gold.',language:'Langue de la vidéo',voice:'Présentation',female:'Femme',male:'Homme',loading:'Chargement de la vidéo …',show:'▶ Voir ASH Workspace Gold en 90 secondes',hide:'Fermer la vidéo',maleFallback:'La version masculine dans cette langue est encore en cours de traitement. En attendant, la version linguistique actuelle peut être affichée.'},
  tr:{title:'ASH Workspace Gold kısaca anlatılıyor',lead:'En güncel ASH Workspace Gold sürümünün açıklayıcı videosu.',language:'Video dili',voice:'Video sunumu',female:'Kadın',male:'Erkek',loading:'Video yükleniyor …',show:'▶ ASH Workspace Gold’u 90 saniyede izleyin',hide:'Videoyu kapat',maleFallback:'Bu dildeki erkek sunucu sürümü hâlâ hazırlanıyor. Hazır olana kadar mevcut dil sürümü geçici olarak gösterilebilir.'},
  pl:{title:'ASH Workspace Gold w skrócie',lead:'Aktualny film objaśniający najnowszą wersję ASH Workspace Gold.',language:'Język filmu',voice:'Prowadzący',female:'Kobieta',male:'Mężczyzna',loading:'Ładowanie filmu …',show:'▶ Zobacz ASH Workspace Gold w 90 sekund',hide:'Zamknij film',maleFallback:'Męska wersja w tym języku jest jeszcze przetwarzana. Do czasu jej ukończenia może być tymczasowo wyświetlana bieżąca wersja językowa.'},
  ru:{title:'ASH Workspace Gold — краткое объяснение',lead:'Актуальное объясняющее видео для последней версии ASH Workspace Gold.',language:'Язык видео',voice:'Ведущий',female:'Женщина',male:'Мужчина',loading:'Видео загружается …',show:'▶ Посмотреть ASH Workspace Gold за 90 секунд',hide:'Закрыть видео',maleFallback:'Мужская версия на этом языке ещё обрабатывается. Пока она не готова, временно может показываться текущая языковая версия.'},
  ar:{title:'شرح مختصر لـ ASH Workspace Gold',lead:'الفيديو التوضيحي الحالي لأحدث إصدار من ASH Workspace Gold.',language:'لغة الفيديو',voice:'مقدم الفيديو',female:'امرأة',male:'رجل',loading:'جارٍ تحميل الفيديو …',show:'▶ شاهد ASH Workspace Gold في 90 ثانية',hide:'إغلاق الفيديو',maleFallback:'لا تزال النسخة الرجالية بهذه اللغة قيد المعالجة. حتى تكتمل قد تظهر مؤقتاً النسخة الحالية باللغة المختارة.'},
  fa:{title:'معرفی کوتاه ASH Workspace Gold',lead:'ویدیوی توضیحی فعلی برای جدیدترین نسخه ASH Workspace Gold.',language:'زبان ویدیو',voice:'ارائه‌دهنده ویدیو',female:'زن',male:'مرد',loading:'در حال بارگذاری ویدیو …',show:'▶ ASH Workspace Gold را در ۹۰ ثانیه ببینید',hide:'بستن ویدیو',maleFallback:'نسخه مردانه در این زبان هنوز در حال پردازش است. تا آماده‌شدن آن ممکن است موقتاً نسخه فعلی همان زبان نمایش داده شود.'},
  ro:{title:'ASH Workspace Gold explicat pe scurt',lead:'Videoclipul explicativ actual pentru cea mai nouă versiune ASH Workspace Gold.',language:'Limba videoclipului',voice:'Prezentator',female:'Femeie',male:'Bărbat',loading:'Se încarcă videoclipul …',show:'▶ Vedeți ASH Workspace Gold în 90 de secunde',hide:'Închideți videoclipul',maleFallback:'Versiunea masculină în această limbă este încă în procesare. Până când este gata, poate fi afișată temporar versiunea curentă în limba selectată.'},
  bg:{title:'ASH Workspace Gold накратко',lead:'Актуалното обяснително видео за най-новата версия на ASH Workspace Gold.',language:'Език на видеото',voice:'Водещ',female:'Жена',male:'Мъж',loading:'Видеото се зарежда …',show:'▶ Вижте ASH Workspace Gold за 90 секунди',hide:'Затворете видеото',maleFallback:'Мъжката версия на този език все още се обработва. Докато стане готова, временно може да се показва текущата версия на избрания език.'},
  vi:{title:'Giới thiệu ngắn về ASH Workspace Gold',lead:'Video giải thích hiện tại cho phiên bản ASH Workspace Gold mới nhất.',language:'Ngôn ngữ video',voice:'Người thuyết trình',female:'Nữ',male:'Nam',loading:'Đang tải video …',show:'▶ Xem ASH Workspace Gold trong 90 giây',hide:'Đóng video',maleFallback:'Phiên bản nam bằng ngôn ngữ này vẫn đang được xử lý. Trong thời gian chờ, phiên bản hiện có của ngôn ngữ đã chọn có thể được hiển thị tạm thời.'}
}
