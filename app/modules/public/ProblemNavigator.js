...
const plans={start:'ASH Workspace Gold Start',klar:'ASH Workspace Gold Klar',analyse:'ASH Workspace Gold Analyse',komplett:'ASH Workspace Gold Komplett',business:'ASH Workspace Gold Business'}
...
const voiceMessages={
  de:{starting:'Mikrofon wird aktiviert …',done:'Sprache wurde übernommen.',noSpeech:'Es wurde keine Sprache erkannt. Tippen Sie erneut auf das Mikrofon und sprechen Sie nach dem Startsignal.',audio:'Das Mikrofon ist auf diesem Gerät nicht verfügbar oder wird gerade von einer anderen App verwendet.',denied:'Der Mikrofonzugriff ist gesperrt. Öffnen Sie die App- bzw. Browser-Einstellungen, erlauben Sie das Mikrofon für ASH Workspace Gold und versuchen Sie es erneut.',network:'Die Spracherkennung ist momentan nicht erreichbar. Bitte versuchen Sie es erneut oder verwenden Sie das Mikrofon Ihrer Tastatur.',insecure:'Die Spracheingabe benötigt eine sichere HTTPS-Verbindung.'},
  en:{starting:'Activating microphone …',done:'Speech was added.',noSpeech:'No speech was recognized. Tap the microphone again and speak after it starts.',audio:'The microphone is unavailable or currently used by another app.',denied:'Microphone access is blocked. Allow the microphone for ASH Workspace Gold in the app or browser settings, then try again.',network:'Speech recognition is temporarily unavailable. Try again or use your keyboard microphone.',insecure:'Voice input requires a secure HTTPS connection.'},
  fr:{starting:'Activation du microphone …',done:'La dictée a été ajoutée.',noSpeech:'Aucune parole reconnue. Touchez de nouveau le microphone et parlez après le démarrage.',audio:'Le microphone est indisponible ou utilisé par une autre application.',denied:'L’accès au microphone est bloqué. Autorisez le microphone pour ASH Workspace Gold dans les réglages de l’application ou du navigateur.',network:'La reconnaissance vocale est momentanément indisponible. Réessayez ou utilisez le microphone du clavier.',insecure:'La saisie vocale nécessite une connexion HTTPS sécurisée.'},
  tr:{starting:'Mikrofon etkinleştiriliyor …',done:'Konuşma metne eklendi.',noSpeech:'Konuşma algılanmadı. Mikrofona yeniden dokunun ve başladıktan sonra konuşun.',audio:'Mikrofon kullanılamıyor veya başka bir uygulama tarafından kullanılıyor.',denied:'Mikrofon erişimi engellendi. Uygulama veya tarayıcı ayarlarından ASH Workspace Gold için mikrofona izin verin.',network:'Ses tanıma şu anda kullanılamıyor. Yeniden deneyin veya klavye mikrofonunu kullanın.',insecure:'Sesli giriş için güvenli bir HTTPS bağlantısı gerekir.'},
  pl:{starting:'Włączanie mikrofonu …',done:'Mowa została dodana.',noSpeech:'Nie rozpoznano mowy. Dotknij mikrofonu ponownie i zacznij mówić po uruchomieniu.',audio:'Mikrofon jest niedostępny lub używany przez inną aplikację.',denied:'Dostęp do mikrofonu jest zablokowany. Zezwól ASH Workspace Gold na mikrofon w ustawieniach aplikacji lub przeglądarki.',network:'Rozpoznawanie mowy jest chwilowo niedostępne. Spróbuj ponownie lub użyj mikrofonu klawiatury.',insecure:'Wprowadzanie głosowe wymaga bezpiecznego połączenia HTTPS.'},
  ru:{starting:'Микрофон включается …',done:'Речь добавлена.',noSpeech:'Речь не распознана. Нажмите микрофон ещё раз и говорите после запуска.',audio:'Микрофон недоступен или используется другим приложением.',denied:'Доступ к микрофону заблокирован. Разрешите микрофон для ASH Workspace Gold в настройках приложения или браузера.',network:'Распознавание речи временно недоступно. Повторите попытку или используйте микрофон клавиатуры.',insecure:'Для голосового ввода требуется защищённое соединение HTTPS.'},
  ar:{starting:'جارٍ تشغيل الميكروفون …',done:'تمت إضافة الكلام.',noSpeech:'لم يتم التعرف على كلام. اضغط على الميكروفون مرة أخرى وتحدث بعد بدء التشغيل.',audio:'الميكروفون غير متاح أو تستخدمه تطبيقات أخرى.',denied:'تم حظر الوصول إلى الميكروفون. اسمح لـ ASH Workspace Gold باستخدامه من إعدادات التطبيق أو المتصفح ثم حاول مجددًا.',network:'التعرف على الكلام غير متاح مؤقتًا. حاول مجددًا أو استخدم ميكروفون لوحة المفاتيح.',insecure:'يتطلب الإدخال الصوتي اتصال HTTPS آمنًا.'},
  fa:{starting:'میکروفون در حال فعال‌شدن است …',done:'گفتار به متن افزوده شد.',noSpeech:'گفتاری تشخیص داده نشد. دوباره روی میکروفون بزنید و پس از شروع صحبت کنید.',audio:'میکروفون در دسترس نیست یا برنامه دیگری از آن استفاده می‌کند.',denied:'دسترسی میکروفون مسدود است. در تنظیمات برنامه یا مرورگر، میکروفون را برای ASH Workspace Gold مجاز کنید.',network:'تشخیص گفتار موقتاً در دسترس نیست. دوباره تلاش کنید یا از میکروفون صفحه‌کلید استفاده کنید.',insecure:'ورودی صوتی به اتصال امن HTTPS نیاز دارد.'},
  ro:{starting:'Se activează microfonul …',done:'Textul dictat a fost adăugat.',noSpeech:'Nu a fost recunoscută nicio voce. Apăsați din nou microfonul și vorbiți după pornire.',audio:'Microfonul nu este disponibil sau este folosit de altă aplicație.',denied:'Accesul la microfon este blocat. Permiteți microfonul pentru ASH Workspace Gold în setările aplicației sau browserului.',network:'Recunoașterea vocală este temporar indisponibilă. Încercați din nou sau folosiți microfonul tastaturii.',insecure:'Introducerea vocală necesită o conexiune HTTPS securizată.'},
  bg:{starting:'Микрофонът се включва …',done:'Речта е добавена.',noSpeech:'Не е разпозната реч. Натиснете микрофона отново и говорете след стартирането.',audio:'Микрофонът не е наличен или се използва от друго приложение.',denied:'Достъпът до микрофона е блокиран. Разрешете микрофона за ASH Workspace Gold в настройките на приложението или браузъра.',network:'Разпознаването на реч временно не е налично. Опитайте отново или използвайте микрофона на клавиатурата.',insecure:'Гласовото въвеждане изисква защитена HTTPS връзка.'},
  vi:{starting:'Đang bật micrô …',done:'Đã thêm lời nói.',noSpeech:'Không nhận diện được lời nói. Hãy nhấn lại micrô và nói sau khi micrô khởi động.',audio:'Micrô không khả dụng hoặc đang được ứng dụng khác sử dụng.',denied:'Quyền truy cập micrô bị chặn. Hãy cho phép ASH Workspace Gold dùng micrô trong cài đặt ứng dụng hoặc trình duyệt.',network:'Nhận diện giọng nói tạm thời không khả dụng. Hãy thử lại hoặc dùng micrô trên bàn phím.',insecure:'Nhập liệu bằng giọng nói cần kết nối HTTPS an toàn.'}
}
