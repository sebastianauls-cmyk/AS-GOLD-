...
const footerCopy={
  de:{nav:'Rechtliche Informationen',withdrawal:'Vertrag widerrufen',integrations:'E-Mail & Speicher',hub:'Rechtliches',imprint:'Impressum',privacy:'Datenschutz',controls:'Datenschutz-Steuerung',terms:'Nutzungsbedingungen',cookies:'Cookies & Speicher',ai:'KI-Transparenz',contact:'Kontakt',binding:'Verbindlich sind die deutschen Rechtstexte.',updated:'Stand'},
  en:{nav:'Legal information',withdrawal:'Withdraw from contract',integrations:'Email & storage',hub:'Legal',imprint:'Legal notice',privacy:'Privacy',controls:'Privacy controls',terms:'Terms of use',cookies:'Cookies & storage',ai:'AI transparency',contact:'Contact',binding:'The German legal texts are authoritative.',updated:'Updated'},
  fr:{nav:'Informations juridiques',withdrawal:'Se rétracter du contrat',integrations:'E-mail et stockage',hub:'Mentions légales',imprint:'Mentions légales',privacy:'Confidentialité',controls:'Contrôles de confidentialité',terms:'Conditions d’utilisation',cookies:'Cookies et stockage',ai:'Transparence IA',contact:'Contact',binding:'Les textes juridiques allemands font foi.',updated:'Mise à jour'},
  tr:{nav:'Yasal bilgiler',withdrawal:'Sözleşmeden cayma',integrations:'E-posta ve depolama',hub:'Yasal',imprint:'Künye',privacy:'Gizlilik',controls:'Gizlilik kontrolü',terms:'Kullanım koşulları',cookies:'Çerezler ve depolama',ai:'Yapay zekâ şeffaflığı',contact:'İletişim',binding:'Almanca hukuki metinler bağlayıcıdır.',updated:'Güncelleme'},
  pl:{nav:'Informacje prawne',withdrawal:'Odstąp od umowy',integrations:'E-mail i pamięć',hub:'Informacje prawne',imprint:'Impressum',privacy:'Prywatność',controls:'Kontrola prywatności',terms:'Warunki korzystania',cookies:'Pliki cookie i pamięć',ai:'Przejrzystość AI',contact:'Kontakt',binding:'Wiążące są niemieckie teksty prawne.',updated:'Aktualizacja'},
  ru:{nav:'Правовая информация',withdrawal:'Отказаться от договора',integrations:'Почта и хранилище',hub:'Правовая информация',imprint:'Выходные данные',privacy:'Конфиденциальность',controls:'Управление приватностью',terms:'Условия использования',cookies:'Cookie и хранилище',ai:'Прозрачность ИИ',contact:'Контакты',binding:'Юридически обязательны тексты на немецком языке.',updated:'Обновлено'},
  ar:{nav:'المعلومات القانونية',withdrawal:'الانسحاب من العقد',integrations:'البريد والتخزين',hub:'الشؤون القانونية',imprint:'بيانات الناشر',privacy:'الخصوصية',controls:'التحكم في الخصوصية',terms:'شروط الاستخدام',cookies:'ملفات الارتباط والتخزين',ai:'شفافية الذكاء الاصطناعي',contact:'التواصل',binding:'النصوص القانونية الألمانية هي الملزمة.',updated:'آخر تحديث'},
  fa:{nav:'اطلاعات حقوقی',withdrawal:'انصراف از قرارداد',integrations:'ایمیل و ذخیره‌سازی',hub:'اطلاعات حقوقی',imprint:'اطلاعات ناشر',privacy:'حریم خصوصی',controls:'کنترل حریم خصوصی',terms:'شرایط استفاده',cookies:'کوکی‌ها و ذخیره‌سازی',ai:'شفافیت هوش مصنوعی',contact:'تماس',binding:'متون حقوقی آلمانی لازم‌الاجرا هستند.',updated:'به‌روزرسانی'},
  ro:{nav:'Informații juridice',withdrawal:'Retragere din contract',integrations:'E-mail și stocare',hub:'Juridic',imprint:'Informații despre furnizor',privacy:'Confidențialitate',controls:'Controlul confidențialității',terms:'Condiții de utilizare',cookies:'Cookie-uri și stocare',ai:'Transparență AI',contact:'Contact',binding:'Textele juridice în limba germană sunt obligatorii.',updated:'Actualizat'},
  bg:{nav:'Правна информация',withdrawal:'Отказ от договора',integrations:'Имейл и съхранение',hub:'Правна информация',imprint:'Данни за доставчика',privacy:'Поверителност',controls:'Контрол на поверителността',terms:'Условия за ползване',cookies:'Бисквитки и съхранение',ai:'Прозрачност на ИИ',contact:'Контакт',binding:'Правно обвързващи са текстовете на немски език.',updated:'Актуализирано'},
