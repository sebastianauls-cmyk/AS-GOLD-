...
export default function OptionalExtensions(){
  return <section aria-labelledby="optional-extensions-title">
    ...
    <p className="lead">ASH Workspace Gold bleibt im Standardbetrieb bewusst schlank. Externe Speicher-, E-Mail- oder Bezahlfunktionen werden nicht automatisch aktiviert. Sie werden erst auf ausdrückliche Anfrage als eigener Baustein eingerichtet.</p>
    ...
    <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(260px,1fr))',gap:16,marginTop:24}}>
      <article style={card}>
        ...
        <a style={request} href={requestHref('ASH Workspace Gold – Cloud-/Ablage-Baustein anfragen','Bitte prüfen Sie die Einrichtung einer optionalen Cloud-/Ablage-Anbindung für ASH Workspace Gold. Gewünschter Dienst: ')}>Cloud-/Ablage-Baustein anfragen</a>
      </article>
      ...
      <article style={card}>
        ...
        <a style={request} href={requestHref('ASH Workspace Gold – Bezahl-Baustein anfragen','Bitte prüfen Sie die Einrichtung einer optionalen Bezahlfunktion für ASH Workspace Gold. Gewünschter Anbieter / Einsatz: ')}>Bezahl-Baustein anfragen</a>
      </article>
    </div>

    <div className="legalNotice" style={{marginTop:24}}><b>Grundprinzip</b><p>Optionale Erweiterungen bleiben technisch und fachlich getrennte Module. Sie werden erst nach ausdrücklicher Freigabe aktiviert, getestet und dokumentiert. Der Kern von ASH Workspace Gold funktioniert ohne diese Erweiterungen.</p></div>
  </section>
}
