...
export default function PrivacyControls(){
  return <LegalDocument title="Datenschutz-Steuerung" intro="Prüfen Sie den aktuellen Kontostatus und schalten Sie KI-Verarbeitung sowie noch offene Dokumentfreigaben aus.">
