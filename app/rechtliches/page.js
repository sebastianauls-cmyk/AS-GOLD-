...
export const metadata={title:'Rechtliches',description:'Zentrale rechtliche Informationen zu ASH Workspace Gold.'}
...
export default function LegalHub(){
  return <LegalDocument pageId="rechtliches" title="Rechtliches" intro="Alle Pflichtinformationen und Kontrollmöglichkeiten für den aktuellen, kostenlosen Testbetrieb von ASH Workspace Gold an einem Ort.">
