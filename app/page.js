Warning: truncated output (original token count: 58400)
...
const uploadUi = {
  ...
  uk:{tooLarge:'Файл перевищує 50 МБ.',unsupported:'Цей формат файлу не підтримується.',testLimit:'Тестовий етап: тимчасово не більше 50 МБ на файл. Остаточний ліміт буде визначено лише після повного опису застосунку.'},
...
const exportUi = {
  ...
  uk:{caseTitle:'AS Gold – огляд справи',documentTitle:'AS Gold – аналіз документа',case:'Справа',status:'Статус',traffic:'Світлофор',summary:'Стан справи',documents:'Документи',document:'Документ',documentType:'Тип документа',documentDate:'Дата документа',analysis:'Аналіз',nextStep:'Наступний крок',extracted:'Витягнутий вміст',none:'Немає',noAnalysis:'Аналізу ще немає.',open:'Відкрито',closed:'Закрито',yellow:'Жовтий',green:'Зелений',red:'Червоний'},
...
const planJourney = {
  ...
  uk:{
    free:{stage:'Рівень 1 · Знайомство',headline:'Просто спробуйте',knowledge:'Не потрібно нічого готувати або знати методи аналізу.',expectation:'Ви хочете побачити, що AS Gold може зробити з вашими документами.'},
    start:{stage:'Рівень 2 · Порядок',headline:'Спочатку потрібен огляд',knowledge:'Ви знаєте свою справу, але не хочете самостійно все сортувати.',expectation:'Ви очікуєте зрозуміле резюме та впорядковані документи.'},
    klar:{stage:'Рівень 3 · Ясність',headline:'Чого бракує і що важливо?',knowledge:'У вас уже є документи й ви хочете бачити прогалини, суперечності та строки.',expectation:'Ви очікуєте чіткі пріоритети, а не лише резюме.'},
    analyse:{stage:'Рівень 4 · Оцінка',headline:'Яка моя ситуація?',knowledge:'Ви хочете зрозуміти зв’язки, ризики та варіанти дій.',expectation:'Ви очікуєте поглиблену оцінку з конкретними наступними кроками.'},
    komplett:{stage:'Рівень 5 · Опрацювання',headline:'Я хочу комплексно опрацювати справу',knowledge:'Справа складна й має бути структурована та опрацьована як єдине ціле.',expectation:'Ви очікуєте аналіз, рекомендації та підготовлені листи в одному процесі.'},
    business:{stage:'Рівень 6 · Business',headline:'Я керую кількома справами та людьми',knowledge:'Ви працюєте з клієнтами, справами, командами, погодженнями, стандартами та процесами.',expectation:'Ви очікуєте контроль, масштабованість, командну роботу та професійне керування процесами.'}
  },
  ru:{
...
const journeyLabels = {
  ...
  uk:{knowledge:'Ваш рівень',expectation:'Ваше очікування',choose:'Який рівень мені підходить?',chooseLead:'Почніть із того рівня, який відповідає вашій потребі сьогодні. Фахові терміни не потрібні; пізніше можна перейти вище.',less:'Простий старт',more:'Більше глибини й контролю'},
...
const dashboardGuide = {
  ...
  uk:{free:{title:'Ласкаво просимо — почніть просто',lead:'Нічого готувати не потрібно. Спочатку завантажте документ, і AS Gold зрозуміло покаже результат.',steps:['1. Завантажте документ','2. Перегляньте результат','3. Вирішіть, чи потрібна більша глибина'],next:'Завантажити перший документ',nextSection:'documents',mode:'Керований старт'},start:{title:'Спочатку впорядкуйте справу',lead:'Створіть клієнта або справу, а потім додайте наявні документи.',steps:['1. Додати клієнта','2. Створити справу','3. Додати документи'],next:'Додати клієнта',nextSection:'clients',mode:'Структурований старт'},klar:{title:'Зробіть прогалини та пріоритети видимими',lead:'Працюйте по справах. Перевіряйте документи, відкриті питання та статус.',steps:['1. Відкрити справу','2. Перевірити документи','3. Визначити пріоритети'],next:'Перевірити справи',nextSection:'cases',mode:'Режим ясності'},analyse:{title:'Оцініть ситуацію, ризики та наступні кроки',lead:'Використовуйте огляд справи як робочий центр.',steps:['1. Обрати справу','2. Перевірити ризики','3. Визначити наступні кроки'],next:'Відкрити аналіз',nextSection:'cases',mode:'Режим аналізу'},komplett:{title:'Опрацьовуйте справу як повний процес',lead:'Клієнти, справи, документи, результати та погодження ведуться в одному процесі.',steps:['1. Перевірити стан','2. Підготувати результати','3. Перевірити …8400 tokens truncated…private',title:'Karmaşık özel işlem',short:'Seyahat, araç, sözleşme',examples:'Seyahat, araç, özel sözleşme veya belge yoğun diğer konular.',help:'Dağınık bilgileri düzenler; kanıtlanan, eksik ve yapılması gerekenleri gösterir.'}
  ]},
  ...
  uk:{nav:'Види справ',chooseCase:'Оберіть відповідний вид справи',freeHint:'Почніть безкоштовно: до 3 документів · без оплати · без автопродовження',eyebrow:'Для кого & коли допомагає',title:'У чому вам зараз потрібна ясність?',lead:'Оберіть вид справи. Одразу побачите приклади, допомогу AS Gold і результат.',typical:'Типові справи',support:'Як допомагає AS Gold',result:'Ви отримуєте',results:['впорядкований огляд справи','видимі прогалини, суперечності та строки','зрозумілу оцінку світлофором','конкретні наступні кроки й відповідні проєкти'],start:'Почати цю справу безкоштовно',stepsTitle:'Три кроки до зрозумілої справи',steps:[['01','Оберіть вид справи','Оберіть найближчу до вашої ситуації категорію.'],['02','Додайте документи','Додайте листи, договори, електронні листи, рахунки або фото.'],['03','Перевірте результат','Перегляньте стан, прогалини, оцінку та наступний крок.']],transparencyDetails:'Показати всі правила прозорості',cases:[
    {key:'insurance',title:'Страхування & збиток',short:'Покриття, збиток, докази',examples:'Майнові, автомобільні, туристичні, медичні або бізнес-збитки та відмови у виплаті.',help:'Впорядковує документи, показує відсутні докази й готує наступні дії.'},
    {key:'property',title:'Оренда & нерухомість',short:'Борг, пошкодження, передача',examples:'Борг, розірвання, пошкодження, передача, витрати й ремонтні обов’язки.',help:'Поєднує договори, платежі, стан, відповідальність, строки та докази.'},
    {key:'contract',title:'Договір & вимога',short:'Рахунок, виконання, розірвання',examples:'Помилкові рахунки, відкриті вимоги, невиконання, зміни й розірвання.',help:'Порівнює договір із фактичними подіями та готує обґрунтовану відповідь.'},
    {key:'authority',title:'Орган & соцстрахування',short:'Рішення, строк, доказ',examples:'Справи з медичною касою, пенсійним органом, митницею чи адміністрацією.',help:'Пояснює офіційні листи, контролює строки й показує відсутні дані.'},
    {key:'work',title:'Робота & розрахунок',short:'Оплата, хвороба, зайнятість',examples:'Розрахунок зарплати, лікарняні, робочий час, доплати й листування.',help:'Зіставляє розрахунки та періоди, позначає суперечності й готує лист.'},
    {key:'business',title:'Бізнес & клієнти',short:'Клієнт, проєкт, погодження',examples:'Клієнтські справи, скарги, проєкти, постачальники й внутрішні погодження.',help:'Об’єднує людей, документи, завдання та рішення в контрольованому процесі.'},
    {key:'dispute',title:'Конфлікт & докази',short:'Хронологія, вимога, доказ',examples:'Тривалі спори із суперечливими твердженнями й великим листуванням.',help:'Готує хронологію та огляд доказів для переговорів, адвоката чи суду.'},
    {key:'private',title:'Складна приватна справа',short:'Подорож, авто, договір',examples:'Проблеми з подорожами, авто, приватними договорами та інші документні справи.',help:'Упорядковує інформацію й показує, що доведено, чого бракує і що робити далі.'}
  ]},
...
const publicAudienceText = {
  ...
  uk:{label:'Для кого',items:['Приватні особи','Самозайняті та малі підприємства','Команди, що ведуть клієнтські справи з великою кількістю документів'],scope:'AS Gold структурує та готує справи. Він не замінює індивідуальну юридичну чи податкову консультацію.'},
...
const periodText = {"de":{"once":"einmalig","d30":"/30 Tage","day30":"30 Tage"},"en":{"once":"one-time","d30":"/30 days","day30":"30 days"},"tr":{"once":"tek sefer","d30":"/30 gün","day30":"30 gün"},"pl":{"once":"jednorazowo","d30":"/30 dni","day30":"30 dni"},"uk":{"once":"одноразово","d30":"/30 днів","day30":"30 днів"},"ru":{"once":"однократно","d30":"/30 дней","day30":"30 дней"},"ar":{"once":"مرة واحدة","d30":"/30 يوماً","day30":"30 يوماً"}}
...
const serverControlText = {
  ...
  uk:{serverAudit:'Серверний аудит',serverAuditHelp:'Ці записи зберігаються на сервері у вашому обліковому записі та не можуть бути змінені або видалені звичайним користувачем.',noServerAudit:'Серверних записів аудиту ще немає.',deletion:'Запит на видалення',deletionHelp:'Запит не видаляє дані одразу. Спочатку перевіряються залежності та можливі вимоги щодо зберігання.',requestDeletion:'Запросити видалення облікового запису',cancelDeletion:'Скасувати запит',deletionPending:'Запит отримано · очікує перевірки',deletionCancelled:'Запит скасовано',deletionRequested:'Запит на видалення зафіксовано. До перевірки нічого автоматично не видаляється.',auditFailed:'Дію виконано, але серверний запис аудиту не вдалося зберегти.'},
...
export default function Home(){
  ...
  useEffect(()=>{
    ...
    if(savedLanguage && languages.some(l=>l.key===savedLanguage)) setLanguage(savedLanguage)
  ...
  useEffect(()=>{
    if(!user?.id) return
    try{ setActivityLog(JSON.parse(localStorage.getItem(`asgold-activity-${user.id}`)||'[]')) }catch{ setActivityLog([]) }
  },[user?.id])

  function recordLocalAction(kind,detail){
    if(!user?.id) return
  ...
  async function recordServerAudit(eventType,detail='',entityType=null,entityId=null){
    if(!user?.id) return false
    const {error}=await supabase.from('audit_events').insert({owner_id:user.id,event_type:eventType,entity_type:entityType,entity_id:entityId,event_data:{detail},source:'app'})
    if(error){ console.error('audit_events',error); return false }
  ...
  async function requestAccountDeletion(){
    ...
    await recordServerAudit('account_deletion_requested','account','account',null)
  ...
  async function cancelAccountDeletion(){
    ...
    await recordServerAudit('account_deletion_cancelled','account','account',null)
    const {data:rows}=await supabase.from('deletion_requests').select('*').eq('owner_id',user.id).order('created_at',{ascending:false})
  ...
  async function loadApp(session){
    ...
    if(!row?.active || row?.status !== 'approved') { setMessage(language==='de'?'Zugang noch nicht freigegeben.':language==='en'?'Access not yet approved.':language==='tr'?'Erişim henüz onaylanmadı.':language==='pl'?'Dostęp nie został jeszcze zatwierdzony.':language==='uk'?'Доступ ще не погоджено.':language==='ru'?'Доступ ещё не подтверждён.':'لم تتم الموافقة على الوصول بعد.'); setScreen('login'); return }
    setAccess(row)
  ...
  useEffect(()=>{
    let alive = true
    supabase.auth.getSession().then(({data:{session}})=>{ if(alive) session ? loadApp(session) : setScreen('public') })
  ...
  useEffect(()=>{
    ...
    ;(async()=>{
      ...
      const pairs = await Promise.all(upgrades.map(async u=>{
        const {data,error}=await supabase.rpc('gold_upgrade_quote',{p_to_plan:u.plan_key,p_term_months:termMonths})
        return [u.plan_key,error?null:data]
      }))
      if(!cancelled){ setQuotes(Object.fromEntries(pairs)); setQuoteLoading(false) }
    })()
    return ()=>{cancelled=true}
  },[screen,termMonths,upgrades.length])
  ...
  async function acknowledgeCurrentLegal(){
    ...
    await recordServerAudit('legal_notices_acknowledged',`${PRIVACY_NOTICE_VERSION} · ${TERMS_VERSION}`,'account',null)
  ...
  async function register(e){
    ...
    if(password.length<8) return setMessage(n.pwMin)
  ...
  async function requestUpgrade(plan){
    setMessage('')
    const {data,error}=await supabase.rpc('gold_request_upgrade',{p_to_plan:plan.plan_key,p_term_months:termMonths})
    if(error) return setMessage(error.message)
    await recordServerAudit('upgrade_requested',`${plan.plan_key} · ${termMonths} months`,'account',null)
  ...
  async function createClient(e){
    ...
    if(error) return setMessage(error.message)
    recordLocalAction('client_created',payload.name); await recordServerAudit('client_created',payload.name,'client',created.id); setData(previous=>({...previous,clients:[created,...previous.clients]})); setNewClient({name:'',email:'',phone:'',notes:''}); setShowClientForm(false); setSection('clients')
  }
  ...
  async function createCase(e){
    ...
    recordLocalAction('case_created',created.title); await recordServerAudit('case_created',created.title,'case',created.id)
  ...
  async function updateCase(caseId,draft){
    ...
    if(error){setMessage(error.message);return false}
    recordLocalAction('case_updated',updated.title); await recordServerAudit('case_updated',updated.title,'case',updated.id)
  ...
  async function createAssessment(caseId,draft){
    ...
    recordLocalAction('assessment_created',created.title); await recordServerAudit('assessment_created',created.title,'case',caseId)
  ...
  async function analyzeDocument(document){
    ...
    await recordServerAudit('document_ai_transfer_authorized',`${document.title||document.id} · ${document.data_classification} · ${PRIVACY_NOTICE_VERSION}`,'document',document.id)
    ...
    recordLocalAction('document_analysis_generated',document.title||document.id)
    const auditSaved=await recordServerAudit('document_analysis_generated',`${document.title||document.id} · provisional`,'document',document.id)
  ...
  async function updateDocument(documentId,draft){
    ...
    recordLocalAction(eventType,updated.title)
    const auditSaved=await recordServerAudit(eventType,updated.title,'document',updated.id)
  ...
  async function createApproval(draft){
    ...
    if(error){setMessage(error.message);return false}
    recordLocalAction('approval_created',created.subject||created.id)
    await recordServerAudit('approval_created',`${created.subject||created.id} · revision ${created.preview_revision}`,'approval',created.id)
  ...
  async function updateApproval(approvalId,draft){
    ...
    recordLocalAction(invalidated?'approval_invalidated':'approval_updated',updated.subject||updated.id)
    await recordServerAudit(invalidated?'approval_invalidated':'approval_updated',`${updated.subject||updated.id} · revision ${updated.preview_revision}`,'approval',updated.id)
  ...
  async function approveApproval(item){
    ...
    if(error){setMessage(error.message);return false}
    if(!updated){setMessage(approvalUi.stale);return false}
    recordLocalAction('approval_approved',updated.subject||updated.id)
    await recordServerAudit('approval_approved',`${updated.subject||updated.id} · revision ${updated.approved_revision}`,'approval',updated.id)
  ...
  async function rejectApproval(item){
    ...
    if(error){setMessage(error.message);return false}
    if(!updated){setMessage(approvalUi.stale);return false}
    recordLocalAction('approval_rejected',updated.subject||updated.id)
    await recordServerAudit('approval_rejected',`${updated.subject||updated.id} · revision ${updated.preview_revision}`,'approval',updated.id)
    setData(previous=>({...previous,approvals:previous.approvals.map(entry=>entry.id===updated.id?updated:entry)}))
    setSelectedApproval(updated)
  ...
  async function uploadDocument(e){
    ...
    recordLocalAction('document_uploaded',file.name); await recordServerAudit('document_uploaded',file.name,'document',insert.data.id); setData(previous=>({...previous,documents:[insert.data,...previous.documents]})); setUploading(false); form.reset(); setSection('documents'); setSelectedDocument(insert.data)
  }
  async function openDocument(doc){
    if(!doc.file_path) return
    const {data:signed,error}=await supabase.storage.from('goldstandard-private').createSignedUrl(doc.file_path,300)
    if(error) return setMessage(error.message)
    recordLocalAction('document_opened',doc.title||doc.id); await recordServerAudit('document_opened',doc.title||doc.id,'document',doc.id); window.open(signed.signedUrl,'_blank','noopener')
  }
  ...
  async function doExport(ref,type){
    ...
    try{
      if(type==='docx'){
        ...
        const XLSX=await import('xlsx'); const wb=XLSX.utils.book_new(); XLSX.utils.book_append_sheet(wb,XLSX.utils.aoa_to_sheet(rows),'AS Gold'); XLSX.writeFile(wb,`${base}.xlsx`)
      } else if(type==='pptx'){
        if(!window.PptxGenJS) await new Promise((resolve,reject)=>{const s=document.createElement('script');s.src='https://cdn.jsdelivr.net/npm/pptxgenjs@4.0.1/dist/pptxgen.bundle.js';s.async=true;s.onload=resolve;s.onerror=()=>reject(new Error(n.pptxLoad));document.head.appendChild(s)})
        const pptx=new window.PptxGenJS();pptx.layout='LAYOUT_WIDE';pptx.author='AS Gold';let slide=pptx.addSlide();slide.addText(rows[0][0],{x:.7,y:.7,w:11.8,h:.6,fontSize:26,bold:true});slide.addText(String(rows[1]?.[1]||ref.item.title||''),{x:.7,y:1.6,w:11.8,h:1,fontSize:20});
        const rest=rows.slice(1);for(let i=0;i<rest.length;i+=4){slide=pptx.addSlide();slide.addText('AS Gold',{x:.6,y:.4,w:2.5,h:.4,fontSize:14,bold:true});rest.slice(i,i+4).forEach((r,j)=>{const yy=1+1.35*j;slide.addText(String(r[0]),{x:.7,y:yy,w:2.6,h:.35,fontSize:14,bold:true});slide.addText(String(r[1]||''),{x:3,y:yy,w:9.2,h:1,fontSize:13,valign:'top',margin:.04})})}await pptx.writeFile({fileName:`${base}.pptx`})
      } else if(type==='csv'){
  ...
  async function exportMyData(){
    ...
    recordLocalAction('account_data_export','JSON')
    await recordServerAudit('account_data_export','JSON','account',null)
  ...
  function protectedWorkspace(content){
    return <><header className="appTop"><div className="brand"><Logo/><b>AS Gold</b></div><div className="appHeaderTools"><span className="legalChip">{t.legal}</span><select value={language} onChange={e=>setLanguage(e.target.value)} aria-label={t.language}>{languages.map(l=><option value={l.key} key={l.key}>{l.short}</option>)}</select><select value={outputLanguage} onChange={e=>setOutputLanguage(e.target.value)} aria-label={t.outputLanguage}><option value="de">{t.germanOutput}</option><option value="en">{t.englishOutput}</option><option value="tr">{t.turkishOutput}</option><option value="pl">{t.polishOutput}</option><option value="uk">{t.ukrainianOutput}</option><option value="ru">{t.russianOutput}</option><option value="ar">{t.arabicOutput}</option></select><button className="secondary" onClick={()=>supabase.auth.signOut()}>{a.logout}</button></div></header><main className="appMain">{message&&<div className="note">{message}</div>}{content}</main><LegalFooter language={language}/></>
  }
  ...
  return <>
    <header className="publicTop">
      <div className="wrap nav">
        ...
        <nav>
          <div className="languageSwitch"><span>{t.language}</span><select value={language} onChange={e=>setLanguage(e.target.value)}>{languages.map(l=><option value={l.key} key={l.key}>{l.short}</option>)}</select></div>
    ...
    <main>
      <div className="legalMarketBar">
        <div className="wrap">
          ...
          <label>{t.outputLanguage}<select value={outputLanguage} onChange={e=>setOutputLanguage(e.target.value)}><option value="de">{t.germanOutput}</option><option value="en">{t.englishOutput}</option><option value="tr">{t.turkishOutput}</option><option value="pl">{t.polishOutput}</option><option value="uk">{t.ukrainianOutput}</option><option value="ru">{t.russianOutput}</option><option value="ar">{t.arabicOutput}</option></select></label>
        </div>
      </div>
