...
Die Änderung betrifft ausschließlich die Sprach- und Darstellungslogik. Tariflogik,
Datenbank, Authentifizierung, Datenschutzgrenzen und Zahlungsstatus bleiben
unverändert. V30 bleibt ein kostenloser kontrollierter Testbetrieb; echte
personenbezogene Kundendaten und Zahlungsvorgänge sind nicht freigegeben.
...
- `npm run build`: erfolgreicher Produktions-Build mit Next.js 15.5.24; 14 von
  14 statischen Routen erzeugt, einschließlich `/testen`.
