...
const translations=fs.readFileSync('app/modules/pricing/promoTranslations.mjs','utf8')
...
console.log('V80 tester full-access guard passed through WorkspaceController and current promo catalog: secure redemption, refreshed Business rights, visible end date, 0 EUR/no renewal contract and 10-tester cap are wired.')
