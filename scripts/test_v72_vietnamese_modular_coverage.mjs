...
const landing=fs.readFileSync('app/modules/public/PublicLanding.js','utf8');assert.match(landing,/<LegalFooter language=\{language\}/);assert.match(landing,/supportedLanguages\.find/);assert.match(landing,/\bvi:\{/);assert.match(landing,/PDF.*Word/);assert.doesNotMatch(landing,/href=\{language==='de'\?'\/testen'/)
