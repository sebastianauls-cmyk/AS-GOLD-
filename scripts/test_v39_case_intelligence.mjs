...
assert.match(layout,/modules\/cases\/V39CaseTimelineAutoAssessment/)
console.log('V39 case intelligence guard passed: module-owned automatic provisional traffic light and chronological case timeline verified.')
