...
assert.doesNotMatch(layout,/V38PrimaryNextStep/)
...
console.log('V38 primary next-step guard passed: direct React recommendation, exactly one recommendation and ten-language copy verified.')
