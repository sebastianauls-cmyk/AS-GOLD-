...
assert.doesNotMatch(layout,/V38PrimaryNextStep/);assert.match(component,/PrimaryNextStepCard/);assert.match(component,/analyzeCaseDeadlines/);assert.doesNotMatch(component,/MutationObserver|document\.createElement|querySelector|innerHTML/);assert.match(directCases,/PrimaryNextStepCard language=\{language\}/)
