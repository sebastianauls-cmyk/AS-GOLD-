...
assert.match(module,/Anbieterfreigabe für AS Gold noch nicht abgeschlossen/)
assert.match(module,/Passwörter von Gmail oder Microsoft werden nicht in AS Gold gespeichert/)
