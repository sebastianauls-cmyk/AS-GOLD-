...
console.log('V80 workspace direct-import guard passed: WorkspaceController imports canonical domain modules directly; only the temporary case-priority bridge remains compatibility-only.')
