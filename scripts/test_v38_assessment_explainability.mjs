...
assert.doesNotMatch(layout,/V38AssessmentExplainability/)

console.log('V38 assessment explainability guard passed: direct React assessment explanation, compatibility adapter and 10-language layer verified.')
