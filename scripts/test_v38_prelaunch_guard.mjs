...
assert.match(testing,/\/api\/tester\/promo/)
assert.match(testing,/timingSafeEqual/)
assert.match(testing,/createHash/)
assert.match(testing,/sessionStorage/)
assert.match(testing,/Bezahlfunktion bleibt deaktiviert/)
assert.doesNotMatch(testing,/aspromo2026/,'promo code must not be embedded as clear text in the tester gate')
...
console.log('V131 pre-launch guard passed: tester access is promo-only while payment, privacy and security boundaries remain locked.')
