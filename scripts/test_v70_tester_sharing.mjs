...
assert.match(page,/AS Gold V70 testen und weiterleiten/)
assert.match(page,/<TesterShareButton\/>/)

console.log('V70 tester-sharing guard passed: native sharing, WhatsApp and clipboard fallback are available in all ten languages.')
