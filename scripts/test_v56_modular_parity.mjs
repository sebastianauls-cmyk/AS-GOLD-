...
const recommender=fs.readFileSync('app/modules/public/problemRecommendationV74.mjs','utf8')
...
assert.match(exportWorkflow,/getV24Copy\(outputLanguage\)/)
assert.match(exportWorkflow,/getV25ApprovalCopy\(outputLanguage\)/)
...
console.log('V80 modular parity guard passed: interface language, output language, public navigator, case discovery and output-language exports are owned by current modular components.')
