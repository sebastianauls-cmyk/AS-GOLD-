...
assert.match(languageModules,/className="outputCustomerButton"/)
assert.match(languageModules,/useCustomerText\[outputLanguage\]/)
...
console.log('V56 modular parity checks passed: V51-V56 behavior is owned by modular public/workspace/language components.')
