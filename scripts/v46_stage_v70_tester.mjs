...
export function TesterGuide(){
  return <LegalDocument pageId="testen" eyebrow="Testerbetrieb V70" title="AS Workspace Gold V70 sicher ausprobieren" intro="Hier können Sie den vollständigen V70-Ablauf prüfen, den Link weiterleiten und ohne echte Kundendaten oder eine Zahlung testen." updated="1. September 2026" localizedExtra={<TesterShareButton/>} localizedExtraAfterSection={0}>
    ...
    <LegalSection title="Testfeedback"><p><a className="primary btn" href="mailto:sebastian.auls@gmail.com?subject=AS%20Workspace%20Gold%20V70%20Testfeedback">Feedback zu V70 senden</a></p><p>V70 ist ein kontrollierter Produkttest. Ergebnisse müssen vor einer verbindlichen Verwendung weiterhin geprüft und ausdrücklich freigegeben werden.</p></LegalSection>
  </LegalDocument>
}
`)

// Keep the public test route closed until the final modular release gate is green.
write('app/testen/page.js',`import { TesterPaused } from '../modules/tester/TesterPaused'\n\nexport const metadata={title:'AS Workspace Gold Testerzugang pausiert',description:'Der kontrollierte AS-Gold-Testerzugang bleibt bis zur vollständigen Modularisierungsabnahme geschlossen.'}\n\nexport default function TestingGuide(){return <TesterPaused/>}\n`)
