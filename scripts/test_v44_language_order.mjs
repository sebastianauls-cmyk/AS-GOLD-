...
assert.ok(publicStart>=0,'public surface must exist in workspace module')
...
console.log('V44 replacement guard passed: interface language naturally precedes output language in workspace React source; DOM rearranger is removed.')
