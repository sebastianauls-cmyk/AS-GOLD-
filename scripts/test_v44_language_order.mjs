...
assert.match(workspace,/v36Languages\.mjs/,'active workspace may use only the compatibility language facade until final import cleanup')
...
console.log('V80 language-order guard passed: WorkspaceController is active and one central language registry owns all app languages.')
