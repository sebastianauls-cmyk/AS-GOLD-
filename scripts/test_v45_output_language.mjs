...
assert.match(workflow,/document_translation/)
assert.match(workflow,/response_letter_de/)
assert.match(workflow,/customer_copy/)
assert.match(fn,/output_language:requestedOutputLanguage/)
assert.doesNotMatch(fn,/gold-ocr-v28/)
console.log('Multilingual document workflow guard passed for all supported languages.')
