...
assert.match(fn,/document_translation/)
assert.match(fn,/response_letter_de/)
assert.match(fn,/customer_copy/)
assert.match(fn,/Vietnamesisch/)
assert.match(fn,/output_language:requestedOutputLanguage/)
assert.match(workflow,/VERSANDFERTIGER ENTWURF/)
assert.match(workflow,/KUNDENKOPIE \/ ÜBERSETZUNG/)
assert.doesNotMatch(fn,/gold-ocr-v28/)
console.log('V81 output-language guard passed: source translation, customer explanation, German ready response and translated customer copy are wired.')
