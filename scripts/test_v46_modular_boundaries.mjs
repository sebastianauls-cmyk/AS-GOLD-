...
assert.doesNotMatch(publicLanding,/V37FirstAction/)
...
assert.doesNotMatch(publicLanguageModules,/customerModuleSlot|\{customerModule\}/)
...
assert.match(publicLanguageModules,/returnToGerman/)
...
assert.doesNotMatch(publicLanguageModules,/customerModuleSlot/)
...
assert.match(currentCss,/\.publicWelcome/)
