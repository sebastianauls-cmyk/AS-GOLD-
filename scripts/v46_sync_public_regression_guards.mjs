...
const v34=`import fs from 'node:fs'
...
fs.writeFileSync('scripts/test_v34_customer_path.mjs',v34)
console.log('V46 public regression guards aligned with direct modular ownership.')
