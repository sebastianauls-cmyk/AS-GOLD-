...
assert.match(panel,/onClick=\{\(\)=>onOpenCase\?\.\(selected\)\}/)
...
console.log('V108 visible synthetic cases passed: all 12 cases open visibly, selection is separate from start, and created test cases retain a clear marker.')
