...
console.log('V110 visible synthetic cases passed: all 12 cases open visibly, selection is separate from start, and created test cases retain a clear marker.')
