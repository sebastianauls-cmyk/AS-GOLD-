...
if(!landing.includes('problemNavigatorRef.current?.speak()')){
...
if(!problem.includes('forwardRef(function ProblemNavigator')){
...
pkg.scripts ||= {}
pkg.scripts['test:v71-microphone']='node scripts/test_v71_direct_microphone_activation.mjs'
if(!pkg.scripts.prebuild.includes('test:v71-microphone')) pkg.scripts.prebuild += ' && npm run test:v71-microphone'
fs.writeFileSync(packagePath,JSON.stringify(pkg,null,2)+'\n')

console.log('V71 direct microphone path is present, idempotent and guarded in prebuild.')
