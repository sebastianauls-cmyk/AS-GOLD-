...
Deno.serve(async(req:Request)=>{
  ...
  const instructions='Lies das Testdokument sachlich aus. Erfinde keine Angaben. Nenne Fristen nur, wenn sie ausdrücklich im Dokument stehen oder unmittelbar aus einem ausdrücklich genannten Datum und Zeitraum folgen. Formuliere Zusammenfassung und nächsten Schritt als vorläufigen organisatorischen Vorschlag, nicht als Rechtsberatung.';
  ...
  return reply(req,{status:'completed',message:'Dokument wurde automatisch ausgelesen. Bitte Ergebnis prüfen und bewusst speichern.',suggested_case_id:null,case_match_reason:null,...parsed});
});
