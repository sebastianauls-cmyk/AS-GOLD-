-- Extend the existing bounded failure categories; ownership, access,
-- metadata limits and function grants are preserved.
...
begin
  ...
  if jsonb_typeof(p_metadata->'code')<>'string' or not (p_metadata->>'code'=any(array[
    'provider_timeout','provider_network','provider_http','provider_rate_limit','provider_quota','provider_auth',
